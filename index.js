...
async function startGojoMdNx() {
    ...
    GojoMdNx.sendMessage(callerId, { text: `「 حظر تلقائي لاتتصل على البوت تفضل رقم المالك واخبره بأن يرفع عنك الحظر 」◣`}, { quoted : pa7rick })
    await sleep(8000)
...
⭐✑ Welcome To Our Comfortable Happy😋, Sometimes Loud😜, Usually Messy🤥, Full Of Love🥰, HOME😌!!`} )
                } else if (anu.action == 'hshshshshshsh') {
